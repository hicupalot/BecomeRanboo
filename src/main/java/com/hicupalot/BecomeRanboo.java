...
public final class BecomeRanboo extends JavaPlugin {
    ...
    public void onEnable() {
       ...
       // getServer().getPluginManager().registerEvents(new FreezeonSight(), this);
        ...
        BukkitTask checkRain = new Weather(this).runTaskTimer(this, 0, 100);
        BukkitTask checkWater = new SoggyPlayers(this).runTaskTimer(this, 0, 100);
    ...
    public void onDisable() {
     System.out.println(ChatColor.GOLD + "[BecomeRanboo] Shutting Down!");
    }
}
